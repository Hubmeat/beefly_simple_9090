            ...
            <div class="content">
              ...
              <el-dialog class="forgetPsd" style="width: 60%; margin: 0 auto;" title="找回密码" :visible.sync="dialogFormVisible">
                ...
                <div slot="footer" class="dialog-footer">
                  ...
                  <el-button class="findPsdBtn cancle" @click="cancelForm">取消</el-button>
                </div>
              </el-dialog>
  ...
  methods: {
    ...
    findPsd() {
      ...
      this.$refs.findPsd.validate((valid) => {
        if (valid) {
          ...
          request.post(host + 'beepartner/system/login/checkAdminePhoneCode')
            .withCredentials()
            .set({
              'content-type': 'application/x-www-form-urlencoded'
            })
    ...
    resetPsd() {
      this.$refs.resetForm.validate((valid) => {
        ...
        if (valid) {
          // 像服务器发送 重置密码的请求
          request.post(host + 'beepartner/system/login/setAdminNewPassword')
            .withCredentials()
            .set({
              'content-type': 'application/x-www-form-urlencoded'
            })
